# **Copied to remove vulnerabilities**
...
-   Supports `authorization_code`, `client_credentials`, `refresh_token` and `password` grant, as well as _extension grants_, with scopes.
